^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package laser_scan_matcher_odom
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* [sys][laser_scan_matcher_odom] Depends on DEB version of CSM; it is no longer built upon compile time
* [sys][laser_scan_matcher_odom] Add simplest unit test
* [feat][laser_scan_matcher_odom, demo.launch] Arg for whether to use RViz or not
...
* [sys] Catkinization: laser_scan_matcher_odom (csm integrated as external project
* [sys] laser_scan_matcher_odom: Remove CSM search in CMakeLists.txt
